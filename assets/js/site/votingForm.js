...
if (votingForm && ordinaryDiv) {
  ...
  const ordinaryCheckboxes = Array.from(votingForm.querySelectorAll('input[data-ordinary]'))
  const presidentCheckboxes = Array.from(votingForm.querySelectorAll('input[data-president]'))
  const evptCheckboxes = Array.from(votingForm.querySelectorAll('input[data-evpt]'))
