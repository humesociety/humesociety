 ...
 *
 * @Route("/conference-manager/submission/email", name="conference_submission_email_")
...
class SubmissionEmailController extends AbstractController
{
    ...
    public function submissionDecision(
        ...
        return $this->redirectToRoute('conference_submission_decision', [
    ...
    public function submissionReminder(
        ...
        // return a redirect to the submission page
        return $this->redirectToRoute('conference_submission_index');
    }
